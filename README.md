...
- **A visible crew** - every crewmate works in its own tmux window, experimental Herdr child workspace or compatibility tab, zellij tab, cmux workspace, or Orca terminal you can watch or type into; the first mate reconciles.
...
```
 ...
 └──┬──────────────┬───────────────┬───┘
    ...
    ▼              ▼               ▼
 ┌────────┐   ┌────────┐      ┌────────┐
 │fm-task1│   │fm-task2│  ... │fm-taskN│   tmux windows, Herdr workspaces/tabs, zellij tabs, cmux workspaces, or Orca terminals
