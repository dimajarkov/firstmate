...
config/calm     Pi-only transcript presentation preference; LOCAL, gitignored, primary-authoritative into secondmate homes; see docs/configuration.md "Pi Calm preference"
