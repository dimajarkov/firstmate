...
The home label deliberately retains the collision-safe machine identity `firstmate` or `2ndmate-<id>` plus a stable short hash of the resolved Firstmate root.
